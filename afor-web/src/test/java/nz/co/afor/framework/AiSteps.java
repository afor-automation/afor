...
public class AiSteps implements En {
    ...
    public AiSteps() {
        ...
        Then("the AI query {string} under the parent AI query {string} should find the field with the attribute {string} value {string}", (String query, String parentQuery, String attribute, String expectedId) ->
                ai(ai(parentQuery), query).shouldHave(attribute(attribute, expectedId)));
    }
}
